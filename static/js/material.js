...
(function ($) {
  ...
  $.material = {
    ...
    "togglebutton": function (selector) {
      // Add fake-checkbox to material checkboxes
      const $input = $((selector) ? selector : this.options.togglebuttonElements)
          .filter(":notmdproc")
          .data("mdproc", true)
    ...
    "radio": function (selector) {
      ...
      const $input = $((selector) ? selector : this.options.radioElements)
          .filter(":notmdproc")
          .data("mdproc", true)
    ...
    "attachInputEventHandlers": function () {
      ...
      $(document)
        ...
        .on("keyup change", ".form-control", function () {
          ...
          let isValid = (typeof $input[0].checkValidity === "undefined" || $input[0].checkValidity());
    ...
    "attachAutofillEventHandlers": function () {
      ...
      $(document)
        .on("focus", "input", function () {
          const $inputs = $(this).parents("form").find("input").not("[type=file]");
